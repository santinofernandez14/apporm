...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[A-Za-z]+$/, { message: 'El nombre solo puede contener letras' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[A-Za-z]+$/, { message: 'El apellido solo puede contener letras' }),
    __metadata("design:type", String)
